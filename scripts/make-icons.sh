...
mkdir "$tmpdir/Saphar.iconset"
cp "$tmpdir/16.png" "$tmpdir/Saphar.iconset/icon_16x16.png"
cp "$tmpdir/32.png" "$tmpdir/Saphar.iconset/icon_16x16@2x.png"
cp "$tmpdir/32.png" "$tmpdir/Saphar.iconset/icon_32x32.png"
cp "$tmpdir/64.png" "$tmpdir/Saphar.iconset/icon_32x32@2x.png"
cp "$tmpdir/128.png" "$tmpdir/Saphar.iconset/icon_128x128.png"
cp "$tmpdir/256.png" "$tmpdir/Saphar.iconset/icon_128x128@2x.png"
cp "$tmpdir/256.png" "$tmpdir/Saphar.iconset/icon_256x256.png"
cp "$tmpdir/512.png" "$tmpdir/Saphar.iconset/icon_256x256@2x.png"
cp "$tmpdir/512.png" "$tmpdir/Saphar.iconset/icon_512x512.png"
cp "$tmpdir/1024.png" "$tmpdir/Saphar.iconset/icon_512x512@2x.png"
iconutil -c icns -o electron_app/build/icon.icns "$tmpdir/Saphar.iconset"
...
cp "$tmpdir/180.png" "electron_app/img/saphar.png"
...
cp "res/vector-icons/favicon.ico" "electron_app/img/saphar.ico"
